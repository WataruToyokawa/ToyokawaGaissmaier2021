...
myTheme_Helvetica = function() {
  theme(
    ...
    strip.background = element_rect(fill = NA),
    #panel.border = element_rect(fill = NA, colour = "black", size = 0.8),
    strip.text = element_text(size=16, family="Helvetica" ), #"Helvetica"
    axis.line = element_line(colour = "#000000", size = 0.5, linetype = "solid", lineend = "round"),
    ...
    axis.text.x = element_text(size=15, family="Helvetica" ,colour='black'),
    ...
    plot.title = element_text(size=15, family="Helvetica", hjust=0.5),
    panel.background = element_rect(fill = "white", colour = NA),
    panel.grid = element_blank(),
    plot.background = element_rect(colour = "white"),
    panel.spacing = unit(0.2, "lines")
